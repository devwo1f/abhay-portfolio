...
export const RelatedItems = ({ items, type }: RelatedItemProps) => {
    ...
    return (
        <div className="py-16 border-t border-border mt-16 flex flex-col items-center">
            ...
            <div className="relative w-full">
                ...
                >
                    {items.length > 0 ? (
                        ...
                        <div className="block w-full max-w-md mx-auto p-12 bg-card/50 border border-dashed border-border rounded-xl opacity-70 snap-start shrink-0 text-center flex flex-col items-center justify-center">
                            <h4 className="text-xl font-medium mb-3 text-muted-foreground">More {type === 'blog' ? 'Articles' : 'Projects'} Coming Soon!</h4>
